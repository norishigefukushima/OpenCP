...
namespace cp
{
	...
	CP_EXPORT void polylines(cv::InputOutputArray src, std::vector<cv::Point2f>& points, const bool isClosed, const cv::Scalar color, const int thickness = 1, const int lineType = 8, const int shift = 0);
