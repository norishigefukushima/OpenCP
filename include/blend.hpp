...
namespace cp
{
	...
	CP_EXPORT cv::Mat guiAlphaBlendScale(cv::InputArray src1, cv::InputArray src2, float scale = 1.f, bool isShowImageStats = false, std::string wname = "alphaBlendScale");
