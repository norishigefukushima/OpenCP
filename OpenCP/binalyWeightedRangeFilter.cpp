...
void jointBinalyWeightedRangeFilter(const Mat& src, const Mat& guide, Mat& dst, int kernelSize, float threshold, int method, int borderType)
{
	jointBinalyWeightedRangeFilter(src,guide, dst,Size(kernelSize,kernelSize),threshold,method,borderType);
}
