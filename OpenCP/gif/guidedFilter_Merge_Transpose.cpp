...
void guidedFilter_Merge_Transpose_nonVec::init()
{
	//cout << "merge_transpose_nonvec::init" << endl;
	...
	else if (guide.channels() == 3)
	{
		...
		vI_t.resize(3);
		for (int i = 0; i < vI_t.size(); i++)
		{
			vI_t[i].create(t_size, CV_32F);
		}
...
void guidedFilter_Merge_Transpose_nonVec::filter_Guide1(cv::Mat& input, cv::Mat& output)
{
	RowSumFilter_Ip2ab_Guide1_Transpose_nonVec		rsf_ip2ab(input, guide, temp, I_t, r, parallelType);	rsf_ip2ab.filter();
	ColumnSumFilter_Ip2ab_Guide1_Transpose_nonVec	csf_ip2ab(temp, a, b, r, eps, parallelType);	csf_ip2ab.filter();
...
void guidedFilter_Merge_Transpose_nonVec::filter_Guide3(cv::Mat& input, cv::Mat& output)
{
	RowSumFilter_Ip2ab_Guide3_Transpose_nonVec		rsf_ip2ab(input, vI, temp, vI_t, r, parallelType);	rsf_ip2ab.filter();
	ColumnSumFilter_Ip2ab_Guide3_Transpose_nonVec	csf_ip2ab(temp, va, b, r, eps, parallelType);	csf_ip2ab.filter();
...
void guidedFilter_Merge_Transpose_SSE::filter_Guide1(cv::Mat& input, cv::Mat& output)
{
	RowSumFilter_Ip2ab_Guide1_Transpose_SSE		rsf_ip2ab(input, guide, temp, I_t, r, parallelType);	rsf_ip2ab.filter();
	ColumnSumFilter_Ip2ab_Guide1_Transpose_SSE	csf_ip2ab(temp, a, b, r, eps, parallelType);	csf_ip2ab.filter();
...
void guidedFilter_Merge_Transpose_SSE::filter_Guide3(cv::Mat& input, cv::Mat& output)
{
	RowSumFilter_Ip2ab_Guide3_Transpose_SSE		rsf_ip2ab(input, vI, temp, vI_t, r, parallelType);	rsf_ip2ab.filter();
	ColumnSumFilter_Ip2ab_Guide3_Transpose_SSE	csf_ip2ab(temp, va, b, r, eps, parallelType);	csf_ip2ab.filter();
...
void guidedFilter_Merge_Transpose_AVX::filter_Guide1(cv::Mat& input, cv::Mat& output)
{
	RowSumFilter_Ip2ab_Guide1_Transpose_AVX		rsf_ip2ab(input, guide, temp, I_t, r, parallelType);	rsf_ip2ab.filter();
	ColumnSumFilter_Ip2ab_Guide1_Transpose_AVX	csf_ip2ab(temp, a, b, r, eps, parallelType);	csf_ip2ab.filter();
...
void guidedFilter_Merge_Transpose_AVX::filter_Guide3(cv::Mat& input, cv::Mat& output)
{
	RowSumFilter_Ip2ab_Guide3_Transpose_AVX		rsf_ip2ab(input, vI, temp, vI_t, r, parallelType);	rsf_ip2ab.filter();
	ColumnSumFilter_Ip2ab_Guide3_Transpose_AVX	csf_ip2ab(temp, va, b, r, eps, parallelType);	csf_ip2ab.filter();
 ...
 * Guide1
 */
void RowSumFilter_Ip2ab_Guide1_Transpose_nonVec::filter_naive_impl()
{
...
void RowSumFilter_Ip2ab_Guide1_Transpose_nonVec::filter_omp_impl()
{
...
void RowSumFilter_Ip2ab_Guide1_Transpose_nonVec::operator()(const cv::Range& range) const
{
...
void RowSumFilter_Ip2ab_Guide1_Transpose_SSE::filter_naive_impl()
{
	for (int j = 0; j < img_row; j++)
	{
		float* I_p1 = I.ptr<float>(j);
...
void RowSumFilter_Ip2ab_Guide1_Transpose_SSE::filter_omp_impl()
{
#pragma omp parallel for
	for (int j = 0; j < img_row; j++)
	{
...
void RowSumFilter_Ip2ab_Guide1_Transpose_SSE::operator()(const cv::Range& range) const
{
	for (int j = range.start; j < range.end; j++)
	{
		float* I_p1 = I.ptr<float>(j);
...
void RowSumFilter_Ip2ab_Guide1_Transpose_AVX::filter_naive_impl()
{
	for (int j = 0; j < img_row; j++)
	{
		float* I_p1 = I.ptr<float>(j);
		...
		float* It_p = I.ptr<float>(j);
		float* v4_p = I_t.ptr<float>(0) + 8 * j;
...
void RowSumFilter_Ip2ab_Guide1_Transpose_AVX::filter_omp_impl()
{
#pragma omp parallel for
	for (int j = 0; j < img_row; j++)
	{
...
void RowSumFilter_Ip2ab_Guide1_Transpose_AVX::operator()(const cv::Range& range) const
{
	for (int j = range.start; j < range.end; j++)
	{
		float* I_p1 = I.ptr<float>(j);
...
void ColumnSumFilter_Ip2ab_Guide1_Transpose_nonVec::filter_naive_impl()
{
...
void ColumnSumFilter_Ip2ab_Guide1_Transpose_nonVec::filter_omp_impl()
{
#pragma omp parallel for
	for (int j = 0; j < img_col; j++)
	{
...
void ColumnSumFilter_Ip2ab_Guide1_Transpose_nonVec::operator()(const cv::Range& range) const
{
	for (int j = range.start; j < range.end; j++)
	{
		float* v0_p1 = tempVec[0].ptr<float>(j);
...
void ColumnSumFilter_Ip2ab_Guide1_Transpose_SSE::filter_naive_impl()
{
	for (int j = 0; j < img_col; j++)
	{
		float* v0_p1 = tempVec[0].ptr<float>(j);
...
void ColumnSumFilter_Ip2ab_Guide1_Transpose_SSE::filter_omp_impl()
{
#pragma omp parallel for
	for (int j = 0; j < img_col; j++)
	{
...
void ColumnSumFilter_Ip2ab_Guide1_Transpose_SSE::operator()(const cv::Range& range) const
{
	for (int j = range.start; j < range.end; j++)
	{
		float* v0_p1 = tempVec[0].ptr<float>(j);
...
void ColumnSumFilter_Ip2ab_Guide1_Transpose_AVX::filter_naive_impl()
{
	for (int j = 0; j < img_col; j++)
	{
		float* v0_p1 = tempVec[0].ptr<float>(j);
...
void ColumnSumFilter_Ip2ab_Guide1_Transpose_AVX::filter_omp_impl()
{
#pragma omp parallel for
	for (int j = 0; j < img_col; j++)
	{
...
void ColumnSumFilter_Ip2ab_Guide1_Transpose_AVX::operator()(const cv::Range& range) const
{
	for (int j = range.start; j < range.end; j++)
	{
		float* v0_p1 = tempVec[0].ptr<float>(j);
...
void RowSumFilter_ab2q_Guide1_Transpose_nonVec::filter_naive_impl()
{
	for (int j = 0; j < img_row; j++)
	{
		...
		float* v0_p = tempVec[0].ptr<float>(0) + j;
		float* v1_p = tempVec[1].ptr<float>(0) + j;
...
void RowSumFilter_ab2q_Guide1_Transpose_nonVec::filter_omp_impl()
{
#pragma omp parallel for
	for (int j = 0; j < img_row; j++)
	{
...
void RowSumFilter_ab2q_Guide1_Transpose_nonVec::operator()(const cv::Range& range) const
{
	for (int j = range.start; j < range.end; j++)
	{
		float* a_p1 = a.ptr<float>(j);
...
void RowSumFilter_ab2q_Guide1_Transpose_SSE::filter_naive_impl()
{
	for (int j = 0; j < img_row; j++)
	{
		float* a_p1 = a.ptr<float>(j);
...
void RowSumFilter_ab2q_Guide1_Transpose_SSE::filter_omp_impl()
{
#pragma omp parallel for
	for (int j = 0; j < img_row; j++)
	{
...
void RowSumFilter_ab2q_Guide1_Transpose_SSE::operator()(const cv::Range& range) const
{
	for (int j = range.start; j < range.end; j++)
	{
		float* a_p1 = a.ptr<float>(j);
...
void RowSumFilter_ab2q_Guide1_Transpose_AVX::filter_naive_impl()
{
	for (int j = 0; j < img_row; j++)
	{
		float* a_p1 = a.ptr<float>(j);
		...
		float* v0_p = tempVec[0].ptr<float>(0) + 8 * j;
		float* v1_p = tempVec[1].ptr<float>(0) + 8 * j;
...
void RowSumFilter_ab2q_Guide1_Transpose_AVX::filter_omp_impl()
{
#pragma omp parallel for
	for (int j = 0; j < img_row; j++)
	{
...
void RowSumFilter_ab2q_Guide1_Transpose_AVX::operator()(const cv::Range& range) const
{
	for (int j = range.start; j < range.end; j++)
	{
		float* a_p1 = a.ptr<float>(j);
...
void ColumnSumFilter_ab2q_Guide1_Transpose_nonVec::filter_naive_impl()
{
	for (int j = 0; j < img_col; j++)
	{
		float* v0_p1 = tempVec[0].ptr<float>(j);
...
void ColumnSumFilter_ab2q_Guide1_Transpose_nonVec::filter_omp_impl()
{
#pragma omp parallel for
	for (int j = 0; j < img_col; j++)
	{
...
void ColumnSumFilter_ab2q_Guide1_Transpose_nonVec::operator()(const cv::Range& range) const
{
	for (int j = range.start; j < range.end; j++)
	{
		float* v0_p1 = tempVec[0].ptr<float>(j);
...
void ColumnSumFilter_ab2q_Guide1_Transpose_SSE::filter_naive_impl()
{
	for (int j = 0; j < img_col; j++)
	{
		float* v0_p1 = tempVec[0].ptr<float>(j);
		...
		for (int i = 1; i <= r; i++)
		{
			...
			mq = _mm_add_ps(_mm_mul_ps(mI, ma), mb);
			_mm_storeu_ps(q_p, _mm_mul_ps(mq, mDiv));
			q_p += q.cols;
		}
		for (int i = r + 1; i < img_row / 4 - r - 1; i++)
		{
...
void ColumnSumFilter_ab2q_Guide1_Transpose_SSE::filter_omp_impl()
{
#pragma omp parallel for
	for (int j = 0; j < img_col; j++)
	{
...
void ColumnSumFilter_ab2q_Guide1_Transpose_SSE::operator()(const cv::Range& range) const
{
	for (int j = range.start; j < range.end; j++)
	{
		float* v0_p1 = tempVec[0].ptr<float>(j);
...
void ColumnSumFilter_ab2q_Guide1_Transpose_AVX::filter_naive_impl()
{
	for (int j = 0; j < img_col; j++)
	{
		float* v0_p1 = tempVec[0].ptr<float>(j);
...
void ColumnSumFilter_ab2q_Guide1_Transpose_AVX::filter_omp_impl()
{
#pragma omp parallel for
	for (int j = 0; j < img_col; j++)
	{
...
void ColumnSumFilter_ab2q_Guide1_Transpose_AVX::operator()(const cv::Range& range) const
{
	for (int j = range.start; j < range.end; j++)
	{
		float* v0_p1 = tempVec[0].ptr<float>(j);
 ...
 * Guide3
 */
void RowSumFilter_Ip2ab_Guide3_Transpose_nonVec::filter_naive_impl()
{
	for (int j = 0; j < img_row; j++)
	{
...
void RowSumFilter_Ip2ab_Guide3_Transpose_nonVec::filter_omp_impl()
{
#pragma omp parallel for
	for (int j = 0; j < img_row; j++)
	{
...
void RowSumFilter_Ip2ab_Guide3_Transpose_nonVec::operator()(const cv::Range& range) const
{
	for (int j = range.start; j < range.end; j++)
	{
		float* s00_p1 = vI[0].ptr<float>(j);
...
void RowSumFilter_Ip2ab_Guide3_Transpose_SSE::filter_naive_impl()
{
	for (int j = 0; j < img_row; j++)
	{
		float* s00_p1 = vI[0].ptr<float>(j);
...
void RowSumFilter_Ip2ab_Guide3_Transpose_SSE::filter_omp_impl()
{
#pragma omp parallel for
	for (int j = 0; j < img_row; j++)
	{
...
void RowSumFilter_Ip2ab_Guide3_Transpose_SSE::operator()(const cv::Range& range) const
{
	for (int j = range.start; j < range.end; j++)
	{
		float* s00_p1 = vI[0].ptr<float>(j);
...
void RowSumFilter_Ip2ab_Guide3_Transpose_AVX::filter_naive_impl()
{
	for (int j = 0; j < img_row; j++)
	{
		float* s00_p1 = vI[0].ptr<float>(j);
...
void RowSumFilter_Ip2ab_Guide3_Transpose_AVX::filter_omp_impl()
{
#pragma omp parallel for
	for (int j = 0; j < img_row; j++)
	{
...
void RowSumFilter_Ip2ab_Guide3_Transpose_AVX::operator()(const cv::Range& range) const
{
	for (int j = range.start; j < range.end; j++)
	{
		float* s00_p1 = vI[0].ptr<float>(j);
...
void ColumnSumFilter_Ip2ab_Guide3_Transpose_nonVec::filter_naive_impl()
{
	for (int j = 0; j < img_col; j++)
	{
...
void ColumnSumFilter_Ip2ab_Guide3_Transpose_nonVec::filter_omp_impl()
{
#pragma omp parallel for
	for (int j = 0; j < img_col; j++)
	{
...
void ColumnSumFilter_Ip2ab_Guide3_Transpose_nonVec::operator()(const cv::Range& range) const
{
	for (int j = range.start; j < range.end; j++)
	{
		float* s00_p1 = tempVec[0].ptr<float>(j);
...
void ColumnSumFilter_Ip2ab_Guide3_Transpose_SSE::filter_naive_impl()
{
	for (int j = 0; j < img_col; j++)
	{
...
void ColumnSumFilter_Ip2ab_Guide3_Transpose_SSE::filter_omp_impl()
{
#pragma omp parallel for
	for (int j = 0; j < img_col; j++)
	{
...
void ColumnSumFilter_Ip2ab_Guide3_Transpose_SSE::operator()(const cv::Range& range) const
{
	for (int j = range.start; j < range.end; j++)
	{
		float* s00_p1 = tempVec[0].ptr<float>(j);	// mean_I_b
...
void ColumnSumFilter_Ip2ab_Guide3_Transpose_AVX::filter_naive_impl()
{
	for (int j = 0; j < img_col; j++)
	{
		float* s00_p1 = tempVec[0].ptr<float>(j);	// mean_I_b
...
void ColumnSumFilter_Ip2ab_Guide3_Transpose_AVX::filter_omp_impl()
{
#pragma omp parallel for
	for (int j = 0; j < img_col; j++)
	{
...
void ColumnSumFilter_Ip2ab_Guide3_Transpose_AVX::operator()(const cv::Range& range) const
{
	for (int j = range.start; j < range.end; j++)
	{
		float* s00_p1 = tempVec[0].ptr<float>(j);	// mean_I_b
...
void RowSumFilter_ab2q_Guide3_Transpose_nonVec::filter_naive_impl()
{
	for (int j = 0; j < img_row; j++)
	{
		...
		float* d0_p = tempVec[0].ptr<float>(0) + j;
		float* d1_p = tempVec[1].ptr<float>(0) + j;
		float* d2_p = tempVec[2].ptr<float>(0) + j;
		float* d3_p = tempVec[3].ptr<float>(0) + j;
...
void RowSumFilter_ab2q_Guide3_Transpose_nonVec::filter_omp_impl()
{
#pragma omp parallel for
	for (int j = 0; j < img_row; j++)
	{
...
void RowSumFilter_ab2q_Guide3_Transpose_nonVec::operator()(const cv::Range& range) const
{
	for (int j = range.start; j < range.end; j++)
	{
		float* s0_p1 = va[0].ptr<float>(j);
...
void RowSumFilter_ab2q_Guide3_Transpose_SSE::filter_naive_impl()
{
	for (int j = 0; j < img_row; j++)
	{
		float* s0_p1 = va[0].ptr<float>(j);
		...
		float* d0_p = tempVec[0].ptr<float>(0) + 4 * j;
		float* d1_p = tempVec[1].ptr<float>(0) + 4 * j;
		float* d2_p = tempVec[2].ptr<float>(0) + 4 * j;
		float* d3_p = tempVec[3].ptr<float>(0) + 4 * j;
...
void RowSumFilter_ab2q_Guide3_Transpose_SSE::filter_omp_impl()
{
#pragma omp parallel for
	for (int j = 0; j < img_row; j++)
	{
...
void RowSumFilter_ab2q_Guide3_Transpose_SSE::operator()(const cv::Range& range) const
{
	for (int j = range.start; j < range.end; j++)
	{
		float* s0_p1 = va[0].ptr<float>(j);
...
void RowSumFilter_ab2q_Guide3_Transpose_AVX::filter_naive_impl()
{
	for (int j = 0; j < img_row; j++)
	{
		float* s0_p1 = va[0].ptr<float>(j);
		...
		float* d0_p = tempVec[0].ptr<float>(0) + 8 * j;
		float* d1_p = tempVec[1].ptr<float>(0) + 8 * j;
		float* d2_p = tempVec[2].ptr<float>(0) + 8 * j;
		float* d3_p = tempVec[3].ptr<float>(0) + 8 * j;
...
void RowSumFilter_ab2q_Guide3_Transpose_AVX::filter_omp_impl()
{
#pragma omp parallel for
	for (int j = 0; j < img_row; j++)
	{
...
void RowSumFilter_ab2q_Guide3_Transpose_AVX::operator()(const cv::Range& range) const
{
	for (int j = range.start; j < range.end; j++)
	{
		float* s0_p1 = va[0].ptr<float>(j);
...
void ColumnSumFilter_ab2q_Guide3_Transpose_nonVec::filter_naive_impl()
{
	for (int j = 0; j < img_col; j++)
	{
...
void ColumnSumFilter_ab2q_Guide3_Transpose_nonVec::filter_omp_impl()
{
#pragma omp parallel for
	for (int j = 0; j < img_col; j++)
	{
...
void ColumnSumFilter_ab2q_Guide3_Transpose_nonVec::operator()(const cv::Range& range) const
{
	for (int j = range.start; j < range.end; j++)
	{
		float* s0_p1 = tempVec[0].ptr<float>(j);
...
void ColumnSumFilter_ab2q_Guide3_Transpose_SSE::filter_naive_impl()
{
	for (int j = 0; j < img_col; j++)
	{
		float* s0_p1 = tempVec[0].ptr<float>(j);
		...
		float* s2_p1 = tempVec[2].ptr<float>(j);
		float* s3_p1 = tempVec[3].ptr<float>(j);
		float* s0_p2 = tempVec[0].ptr<float>(j) + 4;
		float* s1_p2 = tempVec[1].ptr<float>(j) + 4;
		float* s2_p2 = tempVec[2].ptr<float>(j) + 4;
		float* s3_p2 = tempVec[3].ptr<float>(j) + 4;
		...
		for (int i = 1; i <= r; i++)
		{
			mSum0 = _mm_add_ps(mSum0, _mm_load_ps(s0_p2));
			s0_p2 += 4;
			mSum1 = _mm_add_ps(mSum1, _mm_load_ps(s1_p2));
			s1_p2 += 4;
			mSum2 = _mm_add_ps(mSum2, _mm_load_ps(s2_p2));
			s2_p2 += 4;
			mSum3 = _mm_add_ps(mSum3, _mm_load_ps(s3_p2));
			s3_p2 += 4;
		}
		...
		_mm_stream_ps(q_p, _mm_mul_ps(mTmp3, mDiv));
		q_p += step;
...
void ColumnSumFilter_ab2q_Guide3_Transpose_SSE::filter_omp_impl()
{
#pragma omp parallel for
	for (int j = 0; j < img_col; j++)
	{
...
void ColumnSumFilter_ab2q_Guide3_Transpose_SSE::operator()(const cv::Range& range) const
{
	for (int j = range.start; j < range.end; j++)
	{
		float* s0_p1 = tempVec[0].ptr<float>(j);
...
void ColumnSumFilter_ab2q_Guide3_Transpose_AVX::filter_naive_impl()
{
	for (int j = 0; j < img_col; j++)
	{
		float* s0_p1 = tempVec[0].ptr<float>(j);
		...
		float* s2_p1 = tempVec[2].ptr<float>(j);
		float* s3_p1 = tempVec[3].ptr<float>(j);
		float* s0_p2 = tempVec[0].ptr<float>(j) + 8;
		float* s1_p2 = tempVec[1].ptr<float>(j) + 8;
		float* s2_p2 = tempVec[2].ptr<float>(j) + 8;
		float* s3_p2 = tempVec[3].ptr<float>(j) + 8;
		...
		for (int i = 1; i <= r; i++)
		{
			mSum0 = _mm256_add_ps(mSum0, _mm256_load_ps(s0_p2));
			s0_p2 += 8;
			mSum1 = _mm256_add_ps(mSum1, _mm256_load_ps(s1_p2));
			s1_p2 += 8;
			mSum2 = _mm256_add_ps(mSum2, _mm256_load_ps(s2_p2));
			s2_p2 += 8;
			mSum3 = _mm256_add_ps(mSum3, _mm256_load_ps(s3_p2));
			s3_p2 += 8;
		}
		...
		_mm256_stream_ps(q_p, _mm256_mul_ps(mTmp3, mDiv));
		q_p += step;
...
void ColumnSumFilter_ab2q_Guide3_Transpose_AVX::filter_omp_impl()
{
#pragma omp parallel for
	for (int j = 0; j < img_col; j++)
	{
...
void ColumnSumFilter_ab2q_Guide3_Transpose_AVX::operator()(const cv::Range& range) const
{
	for (int j = range.start; j < range.end; j++)
	{
		float* s0_p1 = tempVec[0].ptr<float>(j);
